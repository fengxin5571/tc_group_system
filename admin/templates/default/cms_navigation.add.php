  ...
  <form id="add_form" method="post" action="index.php?act=cms_navigation&op=cms_navigation_save">
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td colspan="2" class=""><label class="validation" for="navigation_title">副标题<?php echo $lang['nc_colon'];?></label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" name="navigation_subtitle" id="navigation_title" class="txt"></td>
