...
$(document).ready(function(){
    //行内ajax编辑
    $('span[nc_type="tag_sort"]').inline_edit({act: 'article_tag',op: 'update_tag_sort'});
    $('span[nc_type="tag_name"]').inline_edit({act: 'article_tag',op: 'update_tag_name'});
});
...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?act=article_tag&op=article_tag_drop');
        $('#tag_id').val(id);
        $('#list_form').submit();
    }
}
