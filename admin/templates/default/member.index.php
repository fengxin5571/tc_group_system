    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover member">
          ...
          <td><p class="name"><strong><?php echo $v['member_name']; ?><?php if($v['member_advisor']){?><font style="color: red">【指导老师】</font><?php }?></strong>(<?php echo $lang['member_index_true_name']?>: <?php echo $v['member_truename']; ?>) 【注册来源：<?php  echo $v['from_store_name']?>】</p>
