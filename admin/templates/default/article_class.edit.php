    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td>
              <li style="float:left">
                <input type="radio" value="0" name="article_type" id="article_type" <?php if($output['class_array']['type'] ==0){?>checked="checked" <?php }?>>
                <label for="nav_location0"><?php echo $lang['article_class_type_default'];?></label>
              </li>
              <li>
                <input type="radio" value="1" name="article_type" id="article_type" <?php if($output['class_array']['type'] ==1){?> checked="checked" <?php }?>>
