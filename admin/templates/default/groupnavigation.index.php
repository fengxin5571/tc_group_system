...
<div class="page">
  ...
  <form method="get" name="formSearch">
    <input type="hidden" value="groupnavigation" name="act">
    <input type="hidden" value="groupnavigation" name="op">
      ...
      <tbody>
        <tr>
          ...
          <td><select name="search_nav_location">
              ...
              <option value="4" <?php if($output['search_nav_location'] == '4'){ ?>selected="selected"<?php } ?>><?php echo $lang['navigation_group_index_nav'];?></option>
            </select></td>
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a class="btns" href="index.php?act=groupnavigation&op=groupnavigation"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?></td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w72 align-center"><a href="index.php?act=groupnavigation&op=navigation_edit&nav_id=<?php echo $v['nav_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>'))window.location = 'index.php?act=groupnavigation&op=navigation_del&nav_id=<?php echo $v['nav_id'];?>';"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
