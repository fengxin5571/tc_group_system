...
class ip_area {
	...
	public function __construct() {
	    if(@file_exists(BASE_DATA_PATH.DIRECTORY_SEPARATOR.'area'.DIRECTORY_SEPARATOR.'area.php')){
	        require_once BASE_DATA_PATH.DIRECTORY_SEPARATOR.'area'.DIRECTORY_SEPARATOR.'area.php';
	        $this->area_array=$area_array;
	    }
		if(@file_exists(BASE_DATA_PATH.DIRECTORY_SEPARATOR.'ipdata'.DIRECTORY_SEPARATOR.'mini.Dat')) {
			$this->func = 'data_mini';
			$this->fp = @fopen(BASE_DATA_PATH.DIRECTORY_SEPARATOR.'ipdata'.DIRECTORY_SEPARATOR.'mini.Dat', 'rb');
			$this->offset = unpack('Nlen', fread($this->fp, 4));
			$this->index  = fread($this->fp, $this->offset['len'] - 4);
		} elseif(@file_exists(BASE_DATA_PATH.DIRECTORY_SEPARATOR.'ipdata'.DIRECTORY_SEPARATOR.'QQWry.Dat')) {
			$this->func = 'data_full';
			$this->fp = @fopen(BASE_DATA_PATH.DIRECTORY_SEPARATOR.'ipdata'.DIRECTORY_SEPARATOR.'QQWry.Dat', 'rb');
		} elseif(@file_exists(BASE_DATA_PATH.DIRECTORY_SEPARATOR.'ipdata'.DIRECTORY_SEPARATOR.'qqwry.dat')) {
			$this->func = 'data_full';
			$this->fp = @fopen(BASE_DATA_PATH.DIRECTORY_SEPARATOR.'ipdata'.DIRECTORY_SEPARATOR.'qqwry.dat', 'rb');
		}
